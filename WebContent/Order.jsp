...
<h4><font color="red">Cancle Order</font></h4>
 <form action="cancle_servlet" method="post">
   
    <label for="cancleorder">OrderNo.</label><br/>
    <input type="text" id="cancleorder" name="cancleorder" placeholder=""><br/>
